...
filtered_products = list(filter(lambda get_items: get_items[1] >=10, products))
print(prices, filtered_products)

#the most convinient way is using lists comprehnsions

prices_1 = [get_items_prices[1] for get_items_prices in products] # instead of using map method
